# final calculator and test to commit
# from https://www.youtube.com/watch?v=F5PfbC5ld-Q&list=PLCC34OHNcOtoC6GglhF3ncJ5rLwQrLGnV&index=6
# Part 1
#   import everything
from tkinter import *
...
# button_clear = Button(root,text="C", padx=40, pady=20, command=lambda : button_clear())  # does not worki
           # works
